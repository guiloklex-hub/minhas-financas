    ...
    <div className="min-h-screen bg-black text-foreground flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-card/60 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-muted text-center mb-8 text-sm">Comece a transformar sua vida financeira</p>
          ...
          {mounted ? (
            <>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-muted ml-1">Senha (mín. 6 caracteres)</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-muted">
                      <Lock size={18} />
                    </div>
              ...
              <p className="mt-8 text-center text-sm text-muted">
                Já tem uma conta?{" "}
                <Link href="/login" className="text-foreground hover:text-emerald-400 transition-colors font-medium">
                  Faça login
                </Link>
              </p>
            </>
