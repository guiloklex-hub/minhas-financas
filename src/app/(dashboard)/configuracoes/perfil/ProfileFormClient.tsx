  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-1">
        <label className="text-xs font-medium text-muted ml-1">E-mail (Login)</label>
        <div className="relative opacity-60 cursor-not-allowed">
          ...
          <input 
            ...
            disabled
            value={email}
            className="w-full pl-10 pr-4 py-3 bg-background border border-border rounded-xl focus:outline-none text-sm text-foreground/80"
          />
        </div>
      </div>

      <div className="space-y-1">
        <label className="text-xs font-medium text-muted ml-1">Nome de Exibição</label>
        <div className="relative">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-3 bg-background border border-border rounded-xl focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all text-sm text-foreground placeholder:text-muted"
      ...
      <div className="space-y-1">
        <label className="text-xs font-medium text-muted ml-1">Foto de Perfil (URL da Imagem)</label>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-muted">
            <LinkIcon size={18} />
          </div>
